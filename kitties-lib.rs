...
pub mod pallet {
    ...
    impl<T: Config> Pallet<T> {
        ...
        pub fn create(origin:OriginFor<T>) -> DispatchResult {
            ...
            KittiyOwner::<T>::insert(kitty_id,&who);
        ...
        pub fn breed(origin: OriginFor<T>, kitty_id_1: KittyIndex,kitty_id_2: KittyIndex) -> DispatchResult {
            ...
            let kitty_id_1 = Self::get_kitty(kitty_id_1).map_err(|_| Error::<T>::InvalidKittyId)?;
            let kitty_id_2 = Self::get_kitty(kitty_id_2).map_err(|_| Error::<T>::InvalidKittyId)?;
    ...
    impl<T: Config> Pallet<T> {
        ...
        //get netx id
        fn get_next__id() -> Result<KittyIndex, ()> {
